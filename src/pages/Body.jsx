...
const Body = () => {
  ...
  return (
    <div className='px-24 lg:mt-24 md:mt-24 flex gap-5 justify-between md:px-10 max-sm:flex-col max-sm:w-full w-full max-sm:px-6 max-sm:pt-20' data-aos="flip-down">
      <div className='body_left mt-28 pl-12 lg:w-1/2 md:w-1/2 w-full'>
      ...
      <div className='body_right pr-8 max-sm:pr-0 lg:w-1/2 md:w-1/2 w-full max-sm:flex max-sm:justify-center max-sm:mt-1 p-5 max-sm:p-2'>
