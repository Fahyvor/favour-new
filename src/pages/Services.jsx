...
const Services = () => {
  return (
    <div className='w-full pb-7' id='services' data-aos="flip-left">
     <h3 className='mt-10 text-center text-xl font-semibold tracking-wider backdrop-blur bg-white shadow-lg bg-opacity-80' style={{ transform: "rotate(2deg)", transformOrigin: "right top" }}>Provide you with the best of Development Services </h3>
